...
{
    public class ExternalWindowContainer : NativeWindow, IUIWindowContainer
    {
        #region Fields
        ...
        private FuguiContext _fuguiContext;
        ...
        public ExternalWindowContainer(UIWindow window, bool showTitleBar)
        {
            ...
            _fuguiContext = FuGui.CreateContext(null);
        ...
        private void UIWindow_OnMove(UIWindow UIWindow)
        {
            if (!_started)
            {
                return;
        ...
        private void UIWindow_OnResize(UIWindow UIWindow)
        {
            SetSize(UIWindow.Size.x, UIWindow.Size.y);
        }
        #endregion
        ...
        public void SetPosition(int x, int y, bool force = false)
        {
            if (!force)
            {
                _worldPosition = MonitorsManager.GetBestPos(x, y, _size.x, _size.y, _worldPosition.x, _worldPosition.y);
            }
            else
            {
