...
namespace Fugui.Framework
{
    public struct UIFrameStyle : IUIElementStyle
    {
        ...
        private static void OnThemeSet()
        {
            ...
            {
                Frame = ImGui.GetStyle().Colors[(int)ImGuiCol.FrameBg],
                HoveredFrame = ImGui.GetStyle().Colors[(int)ImGuiCol.FrameBgHovered],
                ActiveFrame = ImGui.GetStyle().Colors[(int)ImGuiCol.FrameBgActive],

                DisabledFrame = ImGui.GetStyle().Colors[(int)ImGuiCol.FrameBg] * 0.3f,
                DisabledHoveredFrame = ImGui.GetStyle().Colors[(int)ImGuiCol.FrameBg] * 0.3f,
                DisabledActiveFrame = ImGui.GetStyle().Colors[(int)ImGuiCol.FrameBg] * 0.3f,
