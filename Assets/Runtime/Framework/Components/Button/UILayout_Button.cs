...
namespace Fugui.Framework
{
    public partial class UILayout
    {
        ...
        {
            return Button(text, UIElementSize.FullSize, UIButtonStyle.Default);
        }
        ...
        /// <returns>True if the button was clicked, false otherwise.</returns>
        public bool Button(string text, UIElementSize size)
        {
        ...
        {
            return Button(text, UIElementSize.FullSize, style);
        }
        ...
        /// <param name="style">The style to apply to the button.</param>
        /// <returns>True if the button was clicked, false otherwise.</returns>
        public virtual bool Button(string text, UIElementSize size, UIButtonStyle style)
        {
