...
namespace Fugui.Framework
{
    public partial class UILayout
    {
        ...
        public bool Slider(string text, ref int value, SliderFlags flags = SliderFlags.Default)
        {
        ...
        /// <param name="flags">Behaviour flags of the Slider</param>
        /// <returns>True if the value was changed by the user, false otherwise.</returns>
        public bool Slider(string text, ref int value, int min, int max, SliderFlags flags = SliderFlags.Default)
        {
            float val = value;
        ...
        /// <param name="flags">Behaviour flags of the Slider</param>
        /// <returns>True if the value was changed by the user, false otherwise.</returns>
        public bool Slider(string text, ref float value, SliderFlags flags = SliderFlags.Default)
        {
        ...
        /// <param name="flags">Behaviour flags of the Slider</param>
        /// <returns>True if the value was changed by the user, false otherwise.</returns>
        public bool Slider(string text, ref float value, float min, float max, SliderFlags flags = SliderFlags.Default)
        {
        ...
        protected virtual bool _customSlider(string text, ref float value, float min, float max, bool isInt, SliderFlags flags)
        {
            text = beginElement(text, UIFrameStyle.Default);
            ...
            switch (flags)
            {
                ...
                case SliderFlags.NoDrag:
                    drawSlider(text, ref value, min, max, isInt, knobRadius, hoverPaddingY, lineHeight, width, x, y);
                    break;
            }

            endElement(UIFrameStyle.Default);
