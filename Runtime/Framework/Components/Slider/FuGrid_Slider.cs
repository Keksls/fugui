namespace Fu.Framework
{
    public partial class FuGrid
    {
        ...
        protected override bool _customSlider(string text, ref float value, float min, float max, bool isInt, float step, FuSliderFlags flags)
        {
            if (!_gridCreated)
            {
                return false;
            ...
            return base._customSlider(text, ref value, min, max, isInt, step, flags);
        }
    }
}