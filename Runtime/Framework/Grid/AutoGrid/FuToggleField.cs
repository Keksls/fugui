...
{
        /// <summary>
        /// Represents the Fu Toggle Field type.
        /// </summary>
        public class FuToggleField : FuField
        {
            #region Constructors
            /// <summary>
            /// Initializes a new instance of the Fu Toggle Field class.
            /// </summary>
            ...
            public override bool Draw(string objectID, FuGrid grid, object objectInstance)
            {
                ...
                bool updated = grid.Toggle(FuLayout.GetCachedCompositeId(FieldName, "##", objectID), ref isChecked);
                if (updated)
                {
