...
namespace Fu
{
    ...
    public class FuTheme
    {
        ...
        public FuDir WindowMenuButtonPosition = FuDir.Right;
        [FuSlider(0f, 10f)]
        ...
        public FuDir ColorButtonPosition = FuDir.Right;
        [FuDrag(0f, 1f)]
        ...
        {
            return Fugui.Themes.RegisterTheme(this);
        }
        ...
        {
            return Fugui.Themes.UnregisterTheme(this);
        }
        ...
        public void SetAsDefaultDarkTheme()
        {
            ...
            WindowMenuButtonPosition = FuDir.Right;
            ChildRounding = 2.0f;
            ...
            TabMinWidth = 32f;
            TabMaxWidth = 180f;
            ColorButtonPosition = FuDir.Right;
        ...
        internal void Apply(float scale)
        {
            ...
            style.WindowMenuButtonPosition = WindowMenuButtonPosition.ToImGui();
            ...
            style.ColorButtonPosition = ColorButtonPosition.ToImGui();
