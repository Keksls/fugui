...
namespace Fu.Framework
{
    public partial class FuLayout
    {
        ...
        {
            return Button(text, FuElementSize.FullSize.BrutSize, Fugui.Themes.FramePadding, Vector2.zero, Fugui.Themes.CurrentTheme.ButtonsGradientStrenght, FuButtonStyle.Default);
        }
        ...
        {
            return Button(text, size.BrutSize, Fugui.Themes.FramePadding, Vector2.zero, Fugui.Themes.CurrentTheme.ButtonsGradientStrenght, FuButtonStyle.Default);
        }
        ...
        {
            return Button(text, size.BrutSize, Fugui.Themes.FramePadding, Vector2.zero, Fugui.Themes.CurrentTheme.ButtonsGradientStrenght, style);
        }
        ...
        {
            return Button(text, FuElementSize.FullSize.BrutSize, Fugui.Themes.FramePadding, Vector2.zero, Fugui.Themes.CurrentTheme.ButtonsGradientStrenght, style);
        }
        ...
        {
            return Button(text, size.BrutSize, padding, Vector2.zero, Fugui.Themes.CurrentTheme.ButtonsGradientStrenght, FuButtonStyle.Default);
        }
        ...
        {
            return Button(text, size.BrutSize, padding, textOffset, Fugui.Themes.CurrentTheme.ButtonsGradientStrenght, style);
        }
