...
namespace Fu.Framework
{
    public partial class FuLayout
    {
        ...
        protected virtual bool _customColorPicker(string text, bool alpha, ref Vector4 color, FuFrameStyle style)
        {
            ...
            float rounding = Fugui.Themes.FrameRounding;
            ...
            // draw frame
            drawList.AddRect(min, max, ImGui.GetColorU32(Fugui.Themes.GetColor(FuColors.Border)), rounding, ImDrawFlags.RoundCornersDefault, 1f);
            ...
            Vector2 size = new Vector2(404f, 224f + Fugui.Themes.WindowPadding.y * 2f);
            if (alpha)
            {
                size = new Vector2(404f, 212f + Fugui.Themes.WindowPadding.y * 2f);
            }
