...
namespace Fu.Framework
{
    public partial class FuLayout
    {
        ...
        public void Loader_CircleSpinner(float size, int circle_count)
        {
            ...
            float speed = 4f;
            Vector4 main_color = Fugui.Themes.GetColor(FuColors.CheckMark);
            Vector4 backdrop_color = Fugui.Themes.GetColor(FuColors.FrameBg);
        ...
        public void Loader_WavyLine(Vector2 size, float frequency, bool doubleColor = true)
        {
            ...
            Vector4 startColor = Fugui.Themes.GetColor(doubleColor ? FuColors.CheckMark : FuColors.Text);
            Vector4 endColor = Fugui.Themes.GetColor(FuColors.Text);
