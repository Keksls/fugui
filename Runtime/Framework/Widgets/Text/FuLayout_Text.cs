...
namespace Fu.Framework
{
    ...
    public partial class FuLayout
    {
        ...
        {
            bool clicked = InvisibleInteractionAt(GetCachedCompositeId("##FuClickableText_", id), textRect.min, textRect.size, out bool hovered, out bool active, FuButtonFlags.MouseButtonLeft, !LastItemDisabled);
        ...
        public virtual void TextURL(string text, string URL, FuTextStyle style, FuTextWrapping wrapping = FuTextWrapping.None)
        {
            ...
            bool clicked = InvisibleInteractionAt(GetCachedCompositeId("##FuTextUrl_", text), rectMin, rectSize, out bool hovered, out bool active, FuButtonFlags.MouseButtonLeft, !LastItemDisabled);
