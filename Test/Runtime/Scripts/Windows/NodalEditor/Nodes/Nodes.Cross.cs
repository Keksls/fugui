...
{
    /// <summary>
    /// CrossNode for the Fu nodal system. Generated automatically.
    /// </summary>
    public sealed class CrossNode : FuNode
    {
        public override string Title => "Cross";
        ...
        public override void Compute()
        {
            ...
            // Always output v3
            float[] a = ExpandTo(ReadToArray(this, "A", aType, 0f), 3, 0f);
            float[] b = ExpandTo(ReadToArray(this, "B", bType, 0f), 3, 0f);
            Vector3 av = new Vector3(a[0], a[1], a[2]);
            Vector3 bv = new Vector3(b[0], b[1], b[2]);
            Vector3 c = Vector3.Cross(av, bv);
            SetPortValue("Out", "core/v3", c);
        }
