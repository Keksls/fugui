...
{
    /// <summary>
    /// MultiplyNode for the Fu nodal system. Generated automatically.
    /// </summary>
    public sealed class MultiplyNode : FuNode
    {
        ...
        {
            // All types allowed; broadcasting applies.
            return true;
        }
        ...
        public override void Compute()
        {
            ...
            float[] a = ReadToArray(this, "A", aType, 0f);
            float[] b = ReadToArray(this, "B", bType, 1f);
            // Expand arrays: scalar repeat; vectors repeat last component for excess
            float[] ao = ExpandTo(a, outSize, a[0]);
            float[] bo = ExpandTo(b, outSize, b[0]);
