...
{
    /// <summary>
    /// OneMinusNode for the Fu nodal system. Generated automatically.
    /// </summary>
    public sealed class OneMinusNode : FuNode
    {
        public override string Title => "OneMinus";
        ...
        public override void Compute()
        {
            ...
            float[] a = ExpandTo(ReadToArray(this, "A", aType, 1f), outSize, 1f);
