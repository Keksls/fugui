...
{
    /// <summary>
    /// SaturateNode for the Fu nodal system. Generated automatically.
    /// </summary>
    public sealed class SaturateNode : FuNode
    {
        public override string Title => "Saturate";
