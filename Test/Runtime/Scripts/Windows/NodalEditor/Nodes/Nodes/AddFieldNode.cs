...
{
    /// <summary>Add two Field2D.</summary>
    public sealed class AddFieldNode : FuNode
    {
        public override string Title => "Add (Field2D)";
        ...
        {
            AddPort(new FuNodalPort{ Name="A", Direction=FuNodalPortDirection.In, DataType="core/field2D", AllowedTypes=new System.Collections.Generic.HashSet<string>{"core/field2D"}, Data=new ConstantField2D(0f), Multiplicity=FuNodalMultiplicity.Single });
            AddPort(new FuNodalPort{ Name="B", Direction=FuNodalPortDirection.In, DataType="core/field2D", AllowedTypes=new System.Collections.Generic.HashSet<string>{"core/field2D"}, Data=new ConstantField2D(0f), Multiplicity=FuNodalMultiplicity.Single });
        ...
        public override void Compute()
        {
            ...
            SetPortValue("Out","core/field2D", new AddField2D(a,b));
        }
