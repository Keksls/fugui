...
{
    /// <summary>Ridged noise generator (with small preview).</summary>
    public sealed class RidgeFieldNode : FuNode
    {
        public override string Title => "Ridge Field";
        ...
        public override void Compute()
        {
            ...
            var field = new RidgeField2D{ Frequency=f, Amplitude=a, Offset=off };
        ...
        public override void OnDraw(FuLayout layout)
        {
            if (_preview && _prev!=null)
            {
                ...
                layout.Image("##prevRidge"+Id, _prev, new FuElementSize(avW,avW));
            }
